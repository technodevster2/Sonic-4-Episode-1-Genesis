...
; ---------------------------------------------------------------------------
	dc.w PLC_3Main-ArtLoadCues, PLC_3Main2-ArtLoadCues
	dc.w PLC_3Explode-ArtLoadCues, PLC_3GameOver-ArtLoadCues
	dc.w PLC_3GHZ-ArtLoadCues, PLC_3GHZ2-ArtLoadCues
	dc.w PLC_3LZ-ArtLoadCues, PLC_3LZ2-ArtLoadCues
	dc.w PLC_3MZ-ArtLoadCues, PLC_3MZ2-ArtLoadCues
	dc.w PLC_3SLZ-ArtLoadCues, PLC_3SLZ2-ArtLoadCues
	dc.w PLC_3SYZ-ArtLoadCues, PLC_3SYZ2-ArtLoadCues
	dc.w PLC_3SBZ-ArtLoadCues, PLC_3SBZ2-ArtLoadCues
	dc.w PLC_3TitleCard-ArtLoadCues,	PLC_3Boss-ArtLoadCues
	dc.w PLC_3Signpost-ArtLoadCues, PLC_3Warp-ArtLoadCues
	dc.w PLC_3SpeStage-ArtLoadCues, PLC_3GHZAnimals-ArtLoadCues
	dc.w PLC_3LZAnimals-ArtLoadCues,	PLC_3MZAnimals-ArtLoadCues
	dc.w PLC_3SLZAnimals-ArtLoadCues, PLC_3SYZAnimals-ArtLoadCues
	dc.w PLC_3SBZAnimals-ArtLoadCues, PLC_3SpeStResult-ArtLoadCues
	dc.w PLC_3Ending-ArtLoadCues, PLC_3TryAgain-ArtLoadCues
	dc.w PLC_3EggmanSBZ2-ArtLoadCues, PLC_3FZBoss-ArtLoadCues
	dc.w PLC_3ABZ-ArtLoadCues, PLC_3ABZ2-ArtLoadCues, PLC_3ABZAnimals-ArtLoadCues
	dc.w TailsPLC_3Main-ArtLoadCues,	TailsPLC_3Main2-ArtLoadCues
	dc.w TailsPLC_3TitleCard-ArtLoadCues
	dc.w TailsPLC_3Signpost-ArtLoadCues	; 35 - 23
	dc.w MilesPLC_Main-ArtLoadCues		; 38 - 26
	dc.w PLC_3GotThrough-ArtLoadCues							;28
	
PLC_3GotThrough:	dc.w 0
		dc.l Nem_GTA
		dc.w $B000
; ---------------------------------------------------------------------------
; Pattern load cues - standard block 1
; ---------------------------------------------------------------------------
PLC_3Main:	dc.w ((TailsPLC_3Main-PLC_3Main-2)/6)-1
...
TailsPLC_3Main:	dc.w ((MilesPLC_3Main-TailsPLC_3Main-2)/6)-1
		dc.l Nem_Lamp		; lamppost
		dc.w $D800
		dc.l Nem_Hud		; HUD
		dc.w $D940
		dc.l Nem_TailsLives	; lives counter
		dc.w $FA80
		dc.l Nem_Ring		; rings
		dc.w $F640
		dc.l Nem_Points		; points from enemy
...
MilesPLC_3Main:	dc.w ((PLC_3Mainend-MilesPLC_3Main-2)/6)-1
		dc.l Nem_Lamp		; lamppost
		dc.w $D800
		dc.l Nem_Hud		; HUD
		dc.w $D940
		dc.l Nem_MilesLives	; lives counter
		dc.w $FA80
		dc.l Nem_Ring		; rings
		dc.w $F640
		dc.l Nem_Points		; points from enemy
...
; ---------------------------------------------------------------------------
PLC_3Main2:	dc.w ((TailsPLC_3Main2-PLC_3Main2-2)/6)-1
...
TailsPLC_3Main2:	dc.w ((PLC_3Main2end-TailsPLC_3Main2-2)/6)-1
		dc.l Nem_TailsMonitors	; monitors
		dc.w $D000
		dc.l Nem_Shield		; shield
		dc.w $A820
		dc.l Nem_Stars		; invincibility stars
...
; ---------------------------------------------------------------------------
PLC_3TitleCard:	dc.w ((TailsPLC_3TitleCard-PLC_3TitleCard-2)/6)-1
		dc.l Nem_TitleCard
		dc.w $B000

TailsPLC_3TitleCard:	dc.w ((PLC_3TitleCardend-TailsPLC_3TitleCard-2)/6)-1
		dc.l Nem_TitleCard
		dc.w $B000
	PLC_3TitleCardend:
; ---------------------------------------------------------------------------
...
; ---------------------------------------------------------------------------
PLC_3Signpost:	dc.w ((TailsPLC_3Signpost-PLC_3Signpost-2)/6)-1
...
TailsPLC_3Signpost:	dc.w ((PLC_3Signpostend-TailsPLC_3Signpost-2)/6)-1
		dc.l Nem_TailsSignPost	; signpost
		dc.w $D000
		dc.l Nem_Bonus		; hidden bonus points
		dc.w $96C0
		dc.l Nem_BigFlash	; giant	ring flash effect
