...
OptionScreen_Select:
		...
		tst.b	($FFFFFF74).w		; is any unplayable character in Player Select
		bgt.s	Knuckles_not_playable	; if yes, branch
	...
	;	move.w	d0,(Two_player_mode_copy).w
		...
		tst.b	($200001).l	; clear ring
		jsr PlayContinuelives
		move.w	d0,($FFFFFE12).w ; load lives
		move.w	d0,($FFFFFE12).w ; load lives
...
Knuckles_not_playable:
		move.b	#$D2,d0
		jsr	PlaySound_Special	; play buzzer sound
		jmp	OptionScreen_Main
; ===========================================================================
; loc_90B6:
...
OptionScreen_Select_Other:
		cmpi.b	#1,($FFFFFF74).w					; is in Player Select
		bne.s	OptionScreen_Select_Other_Knuckles	; if not, branch
		clr.b	($FFFFFF74).w						; set the Player Select to Sonic
...
OptionScreen_Select_Other_Knuckles:
		...
		bne.s	OptionScreen_Select_Other_Knuckles_2
		move.b	#0,($FFFFF600).w
		move.b	#$3C,($FFFFF600).w
		jmp		OptionScreen_Select_Other_Knuckles_3
OptionScreen_Select_Other_Knuckles_2:
		move.b	#0,($FFFFF600).w
OptionScreen_Select_Other_Knuckles_3:
		rts
...
Option_Controls_Button_A:
		...
		beq.s	Option_Controls_Button_B	; if not, branch
		addi.b	#$10,d2						; add $10 to sound test
		jmp		Option_Controls_Button_Cont
Option_Controls_Button_B:
		btst	#button_B,d0				; is button A pressed?
		beq.s	Option_Controls_Refresh2	; if not, branch
		subi.b	#$10,d2						; subtract $10 from sound test
Option_Controls_Button_Cont:
		cmp.b	d3,d2
...
Option_Controls_Refresh2:
		...
		andi.w	#button_C_mask,d0	; C pressed?
...
TextOptScr_Sonic:			dc.b	$E,_S,_O,_N,_I,_C,__,_A,_N,_D,__,_T,_A,_I,_L,_S
TextOptScr_Miles:			dc.b	$E,__,__,__,__,_N,_U,_L,_L,__,__,__,__,__,__,__
TextOptScr_Tails:			dc.b	$E,__,__,__,__,_N,_U,_L,_L,__,__,__,__,__,__,__
TextOptScr_Knuckles:		dc.b	$E,__,__,__,__,_N,_U,_L,_L,__,__,__,__,__,__,__
TextOptScr_VsModeItems:		dc.b	$10,_st,__,__,_S,_A,_M,_P,_L,_E,__,_T,_E,_S,_T,__,__,_st
TextOptScr_AllKindsItems:	dc.b	$E,__,__,__,__,__,_O,_F,_F,__,__,__,__,__,__,__
TextOptScr_TeleportOnly:	dc.b	$E,__,__,__,__,__,__,_O,_N,__,__,__,__,__,__,__
