...
; ===========================================================================
; routines
Change_Music_Tempo				equ SetTempo
...
flip_angle equ		$33 ; angle about the xequ0 axis (360 degrees equ 256) (twist/tumble)
air_left equ		$28
flip_turned equ		$34 ; 0 for normal, 1 to invert flipping (it's a 180 degree rotation about the axis of Sonic's spine, so he stays in the same position but looks turned around)
...
flips_remaining equ	$35 ; number of flip revolutions remaining
flip_speed equ		$27 ; number of flip revolutions per frame / 256
...
invincibility_time equ	$31 ; and $33 ; remaining
speedshoes_time equ	$32 ; and $35 ; remaining
