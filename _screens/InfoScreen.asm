...
InfoScreen_Data:
	...
	dc.b	2,'   SONIC 1 MEGAHACK:  ULTRA EDITION   ',0
	dc.b	0
	dc.b	0
	dc.b	2,'              CREATED BY              ',0
	...
	dc.b	1,'               MEGA PCM               ',0
	dc.b	1,'                 AND                  ',0
	dc.b	1,'   MEGA PCM: TWO CHANNEL MODE ADDON   ',0
	dc.b	0
	...
	dc.b	0
	dc.b	0
	dc.b	1,'THE HACK HAS BEEN DEVELOPED IN 14     ',0
	dc.b	1,'DAYS, EXCEPT FOR THE FOLLOWING PRE-   ',0
