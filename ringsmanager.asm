...
; loc_16F9A:
RingsManager_Init:
	addq.b	#2,($FFFFFFCE).w ; => RingsManager_Main
...
loc_170D0_2:
	...
	bcc.w	return_17166
	btst	#5,status_secondary(a0)	; does Sonic have a lightning shield?
...
Touch_Rings_NoAttraction:
	...
	bne.s	Touch_Rings_NoAttraction2
	addi.w	#$C,d3
	moveq	#$A,d5
Touch_Rings_NoAttraction2:
	move.w	#6,d1
	move.w	#$C,d6
	move.w	#$10,d4
	add.w	d5,d5
