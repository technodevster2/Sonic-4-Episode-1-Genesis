...
conv0To256  macro	num,num2
			dc.b	num,((num2==0)<<8)|num2
			endm
s2TempotoS1 macro	num,num2
			dc.b	num,(((768-num2)>>1)/(256-num2))&$FF
			endm
s2TempotoS3 macro	num,num2
			num,($100-((num2==0)|num2))&$FF
			endm
s1TempotoS2 macro	num,num2
			dc.b	num,((((conv0To256(num2)-1)<<8)+(conv0To256(num2)>>1))/conv0To256(num2))&$FF
			endm
s1TempotoS3 macro	num,num2
			dc.b	num,s2TempotoS3(s1TempotoS2(num2))
			endm
s3TempotoS1 macro	num,num2
			dc.b	num,s2TempotoS1(s2TempotoS3(num2))
			endm
s3TempotoS2 macro	num,num2
			dc.b	num,s2TempotoS3(num2)
			endm