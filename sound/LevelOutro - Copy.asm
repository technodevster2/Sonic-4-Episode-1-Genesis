...
Level_Outro_DAC:
	...
	dc.b	dSnare, dKick, dKick, dSnare, dKick, $01, nRst, dKick, dKick, nRst, dKick, dHiTimpani
	dc.b	$06, dMidTimpani, dLowTimpani, dHiTimpani, dMidTimpani, dLowTimpani, dHiTimpani, dMidTimpani, dLowTimpani, dSnare
	smpsStop
