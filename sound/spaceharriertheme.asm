...
SonicRetroSH_Header:
	smpsHeaderVoice	SonicRetroSH_Voices
	smpsHeaderChan	$06,	$03
	smpsHeaderTempo	$01,	$03

	smpsHeaderDAC	SonicRetroSH_DAC
	smpsHeaderFM	SonicRetroSH_FM1,	smpsPitch02lo,	$04
	smpsHeaderFM	SonicRetroSH_FM2,	smpsPitch00,	$0D
	smpsHeaderFM	SonicRetroSH_FM3,	smpsPitch00,	$10
	smpsHeaderFM	SonicRetroSH_FM4,	smpsPitch00,	$0F
	smpsHeaderFM	SonicRetroSH_FM5,	smpsPitch00,	$10
	smpsHeaderPSG	SonicRetroSH_PSG1,	smpsPitch03lo,	$00,	$03
	smpsHeaderPSG	SonicRetroSH_PSG2,	smpsPitch03lo,	$00,	$05
	smpsHeaderPSG	SonicRetroSH_PSG3,	smpsPitch02hi,	$05,	$05
...
SonicRetroSH_Loop01:
	...
	smpsLoop	$00,	$18,	SonicRetroSH_Loop01
...
SonicRetroSH_Loop02:
	...
	smpsPan		panCentre,	$00
	dc.b		nBb4,	$04
	smpsLoop	$00,	$04,	SonicRetroSH_Loop02
SonicRetroSH_Loop03:
	smpsPan		panLeft,	$00
	dc.b		nEb5,	$04
	smpsPan		panCentre,	$00
	...
	smpsPan		panCentre,	$00
	dc.b		nAb4,	$04
	smpsLoop	$00,	$04,	SonicRetroSH_Loop03
SonicRetroSH_Loop04:
	smpsPan		panLeft,	$00
	dc.b		nEb5,	$04
	smpsPan		panCentre,	$00
	...
	smpsPan		panCentre,	$00
	dc.b		nAb4,	$04
	smpsLoop	$00,	$04,	SonicRetroSH_Loop04
SonicRetroSH_Loop05:
	smpsPan		panLeft,	$00
	dc.b		nEb5,	$04
	smpsPan		panCentre,	$00
	...
	smpsPan		panCentre,	$00
	dc.b		nBb4,	$04
	smpsLoop	$00,	$04,	SonicRetroSH_Loop05
SonicRetroSH_Loop06:
	smpsPan		panLeft,	$00
	dc.b		nEb5,	$04
	smpsPan		panCentre,	$00
	...
	smpsPan		panCentre,	$00
	dc.b		nBb4,	$04
	smpsLoop	$00,	$04,	SonicRetroSH_Loop06
SonicRetroSH_Loop07:
	smpsPan		panLeft,	$00
	dc.b		nEb5,	$04
	smpsPan		panCentre,	$00
	...
	smpsPan		panCentre,	$00
	dc.b		nAb4,	$04
	smpsLoop	$00,	$04,	SonicRetroSH_Loop07
	smpsPan		panLeft,	$00
	dc.b		nAb5,	$04,	nRst
	smpsPan		panCentre,	$00
	dc.b		nEb5,	$04,	nRst
...
SonicRetroSH_Loop08:
	...
	smpsLoop	$00,	$03,	SonicRetroSH_Loop08
	smpsStop
...
SonicRetroSH_Loop09:
	...
	dc.b		nRst
	smpsLoop	$00,	$03,	SonicRetroSH_Loop09
...
SonicRetroSH_Voices:
	...
	dc.b		$00,$10,$07,$10,$07,$1A,$80;			Voice 02
	even
