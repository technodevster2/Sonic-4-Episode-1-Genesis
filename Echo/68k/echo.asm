...
SoundDriverLoad:
	lea		Echo_PointerList, a0					; Instrument pointer list to a0
...
Echo_Init:
    ...
    lea     Echo_Z80Code, a0    	; Where Z80 program starts
    lea     ($A00000), a1           ; Where Z80 RAM starts
    move.w  #Echo_Z80Code_End-Echo_Z80Code, d0		; Compute size of the Z80 program
